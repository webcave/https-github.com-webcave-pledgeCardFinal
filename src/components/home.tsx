    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <footer className="w-full bg-gray-900 text-gray-300 py-12 px-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="h-8 w-8 rounded-full bg-primary flex items-center justify-center">
                <span className="text-primary-foreground font-bold">GF</span>
              </div>
            ...
            <p className="text-sm text-gray-400">
              A platform for fundraising with flexible donation options
              including pledges for future contributions.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-6 border-t border-gray-800 text-sm text-gray-400">
          <p>
            © {new Date().getFullYear()} GoFundMe Clone. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
